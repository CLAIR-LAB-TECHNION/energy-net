...
class TestConsumptionUnit(unittest.TestCase):
    ...
    def test_update(self):
        ...
        # Now accepts state parameter (float is interpreted as time for backward compatibility)
        self.consumption_unit.update(state=0.5)  # Update the unit at time 0.5
    ...
    def test_reset(self):
        ...
        self.consumption_unit.update(state=0.5)  # Update the unit first
